...
public class LabClass
{
  ...
  setRoom("AB123");
  setTime("Monday, 11am");
  Student s1 = new Student("Jo Bloggs", "S01234", 0);
  Student s2 = new Student("John Smith", "S01235", 0);
  enrollStudent(s1);
  enrollStudent(s2);
  printList();
 } 
    ...
    /**
     * Print out student and their credits
     */
    ...
    /**
     * Return the average credits of the class
     */
    public void avCred()
    {
        int avCr;
        avCr=0;
        for(Student student: students){
            avCr+=student.credits;
        }
        avCr=avCr/students.size();
        System.out.println("Class average credit: " + avCr);
    }
